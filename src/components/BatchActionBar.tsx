    ...
    return (
      <div
        style={{
          ...
          boxShadow:
            "0 20px 48px rgba(0, 0, 0, 0.8), 0 0 0 1px rgba(255,255,255,0.06)",
      ...
      >
              ...
              >
                ...
                {playlists.map((pl) => (
                  ...
                  >
                    ...
                    <span style={{ fontSize: "11px", color: "var(--v-fg3)" }}>
                      {pl.tracks.length}
                    </span>
                  </button>
                ))}
        ...
        {(isOfflineView || isPlaylistView) && onDeleteSelected && (
          <button
            ...
            onMouseEnter={(e) => {
              e.currentTarget.style.background = "rgba(224, 85, 85, 0.22)";
            }}
            onMouseLeave={(e) => {
              e.currentTarget.style.background = "rgba(224, 85, 85, 0.12)";
            }}
            title={
              isPlaylistView ? "Remove from playlist" : "Delete offline files"
            }
          >
            <Trash2 size={13} />
