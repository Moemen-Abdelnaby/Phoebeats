...
export const LyricsView: React.FC<LyricsViewProps> = ({
  ...
  const progressSeconds = usePlaybackProgress(showLyrics);
  React.useEffect(() => {
  ...
  const pct =
    trackDurationSeconds > 0
      ? Math.min((progressSeconds / trackDurationSeconds) * 100, 100)
      : 0;
    ...
    >
      ...
      <div
        style={{
          ...
          pointerEvents: "none",
          background:
            "radial-gradient(circle at 70% 50%, rgba(255,255,255,0.02) 0%, rgba(0,0,0,0.45) 70%)",
        }}
      />
      ...
      >
        ...
        >
          {getTrackCover(currentTrack) ? (
            ...
            >
              <Music size={32} style={{ color: "var(--v-fg3)" }} />
            </div>
          )}
        </div>
        ...
        {(() => {
          ...
          return (
            ...
            >
              ...
              >
                {(() => {
                  const artistParts = parseArtistParts(
                    meta.artist || currentTrack.artist,
                  );
                  const canClickAny = Boolean(
                    onArtistClick && !currentTrack.url.startsWith("local://"),
                  );
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "20px" }}>
          <button
            ...
            style={{
              position: "relative",
              color: shuffle ? "var(--v-fg)" : "rgba(255,255,255,0.35)",
              background: "none",
              border: "none",
              cursor: "pointer",
              display: "flex",
            ...
            onMouseLeave={(e) =>
              (e.currentTarget.style.color = shuffle
                ? "var(--v-fg)"
          ...
          >
            {isLoadingTrack && !isPlaying ? (
              ...
              <Pause fill="#000" stroke="#000" size={18} />
            ) : (
              <Play
                fill="#000"
                stroke="#000"
          ...
          <button
            ...
            style={{
              position: "relative",
              color:
                repeatMode !== "off" ? "var(--v-fg)" : "rgba(255,255,255,0.45)",
              background: "none",
              border: "none",
              cursor: "pointer",
              display: "flex",
        ...
        >
          <button
            ...
            style={{
              ...
              flexShrink: 0,
              padding: "2px",
              color: volume === 0 ? "#e05555" : "rgba(255,255,255,0.45)",
              display: "flex",
              transition: "all .12s ease",
            }}
            onMouseEnter={(e) =>
              (e.currentTarget.style.color =
                volume === 0 ? "#ff7070" : "rgba(255,255,255,0.8)")
            }
            onMouseLeave={(e) =>
              (e.currentTarget.style.color =
                volume === 0 ? "#e05555" : "rgba(255,255,255,0.45)")
            }
          >
            ...
            >
              <div
                style={{
                  ...
                  width: `${volume}%`,
                  background:
                    volume > 0 ? "var(--v-fg)" : "rgba(255,255,255,0.18)",
                  transition: "none",
                }}
              >
                <div
      ...
      >
        {lyricsLoading ? (
          ...
          <div style={{ position: "relative", height: "100%" }}>
            ...
            >
              {lines.map(
                (line: { time: number; text: string }, idx: number) => {
                    ...
                    distance <= 1
                      ...
                      : distance <= 2
                        ...
                        : distance <= 3
                          ...
                          : 0.18;
                  const pastOpacity =
                    distance <= 1 ? 0.3 : distance <= 2 ? 0.22 : 0.15;
                  return (
                    <p
                      key={idx}
                      data-active={isCurrent ? "true" : "false"}
                      onClick={async () => {
                        await invoke("seek_audio", { time: line.time }).catch(
                          () => {},
                        );
                      }}
                      onMouseEnter={(e) => {
                      ...
                      onMouseLeave={(e) => {
                        if (!isCurrent) {
                          (e.currentTarget as HTMLElement).style.color = isPast
                            ? `rgba(255,255,255,${pastOpacity})`
                            : `rgba(255,255,255,${futureOpacity})`;
                        }
                      }}
                      style={{
                        cursor: "pointer",
                        ...
                        color: isCurrent
                          ...
                          : isPast
                            ...
                            : `rgba(255,255,255,${futureOpacity})`,
                        transition:
                          "color 0.3s ease, font-size 0.3s ease, font-weight 0.3s ease",
                        textShadow: "none",
                      }}
                    >
                      {line.text || "\u00A0"}
