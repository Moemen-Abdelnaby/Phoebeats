    ...
    return (
      ...
      >
        ...
        <button
          ...
          onMouseLeave={(e) => {
            if (!isLiked) e.currentTarget.style.color = "var(--v-fg3)";
          }}
        >
...
export const HistoryView: React.FC<HistoryViewProps> = React.memo(
  ({
    ...
    const [internalHoveredUrl, setInternalHoveredUrl] = useState<string | null>(
      null,
    );
    ...
    const setHoveredTrackUrl =
      customSetHoveredTrackUrl || setInternalHoveredUrl;

    const [searchQ, setSearchQ] = useState("");

    const getTrackCover =
      customGetTrackCover || ((t: Track | null | undefined) => t?.cover || "");
            ...
            >
              ...
              >
                ...
                <span>
                  ...
                  {uniqueHistory.length === 1 ? "song" : "songs"}
                </span>
              </div>
              <div
                style={{
        ...
        {filteredHistory.length > 0 ? (
          <VirtualTrackList
            ...
            renderItem={(item, index) => {
              ...
              const isLoadingThis =
                isCurrent && (isLoadingTrack || loadingTrackUrl === track.url);
          ...
          >
            ...
            >
              Every unique song you play in Phoebeats will be automatically
