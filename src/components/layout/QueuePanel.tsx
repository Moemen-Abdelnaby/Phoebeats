...
interface QueuePanelProps {
  ...
  playlistContextRef: React.MutableRefObject<{
    tracks: Track[];
    index: number;
  } | null>;
  ...
  ({
    ...
    const handleSaveQueueAsPlaylist = () => {
      ...
      if (onlineTracks.length === 0) {
        showToast(
          "Cannot save playlist: offline tracks cannot be added to playlists",
        );
        return;
      }
              ...
              >
                ...
                {queue.length > 0 &&
                  (showClearConfirm ? (
                    ...
                    >
                      <span style={{ color: "#b05555", fontWeight: 500 }}>
                        Clear?
                      </span>
                      <button
                        onClick={() => {
                    ...
                    <>
                      ...
                      {queue.map((track, i) => (
                        <div
                          ...
                          onContextMenu={(e) =>
                            openCtx(e, { type: "queue-track", track })
                          }
                        >
                          {dragOverQueueIdx === i &&
                          ...
                          >
                            ...
                            <div
                              className="v-queue-play-overlay"
                              style={{
                                position: "absolute",
                                inset: 0,
