      ...
      <>
        ...
        <div
          style={{
            ...
            borderRadius: "50%",
            background:
              "radial-gradient(circle, rgba(226,221,217,0.035) 0%, rgba(0,0,0,0) 70%)",
            pointerEvents: "none",
            zIndex: 0,
          }}
        />
        ...
        >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    borderRadius: "8px",
                    background:
                      isDownloadsFlyoutOpen || activeCount > 0
            ...
            <div
              ...
              onClick={() =>
                onOpenShortcuts ? onOpenShortcuts() : _navigateTo("home")
              }
