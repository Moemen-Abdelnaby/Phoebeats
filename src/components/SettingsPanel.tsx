  ...
  return (
    <button
      ...
      style={{
        ...
        borderRadius: "12px",
        flexShrink: 0,
        background: checked ? "var(--v-accent)" : "var(--v-bg2)",
        border: "1px solid",
        borderColor: checked
          ? "var(--v-accent)"
          : hovered
    ...
    >
      <span
        style={{
          ...
          height: "16px",
          borderRadius: "50%",
          background: checked ? "var(--pb-bg-deep)" : "var(--v-fg3)",
          transition: "all 0.25s cubic-bezier(0.4, 0, 0.2, 1)",
...
export type SettingsPanelProps = {
  ...
  setDuplicateDetect: (v: boolean) => void;
  onBackup: () => void;
  onRestore: () => void;
  onReset: () => void;
  backupPath: string;
  ...
  setLoudnormEnabled: (e: boolean) => void;
  skipSilence: boolean;
  setSkipSilence: (v: boolean) => void;

  eq: { bass: number; mid: number; treble: number };
  setEq: (v: { bass: number; mid: number; treble: number }) => void;
  showToast: (m: string) => void;
  updateAvailable: string | null;
  appVersion: string;
  lyricsSource: string;
  setLyricsSource: (v: string) => void;
  trayEnabled: boolean;
  setTrayEnabled: (v: boolean) => void;
  ...
  setDiscordTimeDisplay?: (v: "remaining" | "elapsed") => void;
  discordCustomBtn?: boolean;
  setDiscordCustomBtn?: (v: boolean) => void;
  discordBtnLabel?: string;
  setDiscordBtnLabel?: (v: string) => void;
  discordBtnUrl?: string;
  setDiscordBtnUrl?: (v: string) => void;
  lastfmEnabled?: boolean;
  setLastfmEnabled?: (v: boolean) => void;
  lastfmSessionKey?: string;
  setLastfmSessionKey?: (k: string) => void;
  lastfmApiKey?: string;
  setLastfmApiKey?: (k: string) => void;
  lastfmApiSecret?: string;
  setLastfmApiSecret?: (s: string) => void;
  lastfmUsername?: string;
  setLastfmUsername?: (u: string) => void;
  theme: string;
  setThemeState: (t: string) => void;
  accentColor: string;
  setAccentColorState: (a: string) => void;
  customBgColor: string;
  setCustomBgColorState: (c: string) => void;
...
export const SettingsPanel = React.memo(function SettingsPanel({
  ...
  setDiscordCustomBtn: propSetDiscordCustomBtn,
  discordBtnLabel: propDiscordBtnLabel,
  setDiscordBtnLabel: propSetDiscordBtnLabel,
  discordBtnUrl: propDiscordBtnUrl,
  setDiscordBtnUrl: propSetDiscordBtnUrl,
  lastfmEnabled = false,
  setLastfmEnabled = () => {},
  ...
  performanceMode,
  setPerformanceMode,
  startupNav: propStartupNav,
  setStartupNav: propSetStartupNav,
  cacheEnabled: propCacheEnabled,
  setCacheEnabled: propSetCacheEnabled,
  uiScale: propUiScale,
  setUiScale: propSetUiScale,
}: SettingsPanelProps) {
  ...
  const matchCard = (keywords: (string | undefined | null | number)[]) => {
    ...
    return tokens.every((token) =>
      validKeywords.some((kw) => kw.includes(token)),
    );
  };
  ...
  const [cacheLimit, setCacheLimit] = useState<string>(() =>
    loadLS("vg_cacheLimit", "1gb"),
  );

  const [localDiscordTimeDisplay, setLocalDiscordTimeDisplay] = useState<
    "remaining" | "elapsed"
  >(() => {
  ...
  const [localDiscordBtnLabel, setLocalDiscordBtnLabel] = useState<string>(() =>
    loadLS("vg_discordBtnLabel", ""),
  );
  const [localDiscordBtnUrl, setLocalDiscordBtnUrl] = useState<string>(() =>
    loadLS("vg_discordBtnUrl", ""),
  );

  const discordTimeDisplay =
    propDiscordTimeDisplay !== undefined
      ? propDiscordTimeDisplay
      : localDiscordTimeDisplay;
  ...
  const discordCustomBtn =
    propDiscordCustomBtn !== undefined
      ? propDiscordCustomBtn
      : localDiscordCustomBtn;
  ...
  const discordBtnLabel =
    propDiscordBtnLabel !== undefined
      ? propDiscordBtnLabel
      : localDiscordBtnLabel;
  ...
  const discordBtnUrl =
    propDiscordBtnUrl !== undefined ? propDiscordBtnUrl : localDiscordBtnUrl;
  ...
  const [networkProxy, setNetworkProxy] = useState<string>(() =>
    loadLS("vg_networkProxy", ""),
  );
  const [customInstance, setCustomInstance] = useState<string>(() =>
    loadLS("vg_customInstance", ""),
  );
  ...
  const [internalCacheEnabled, setInternalCacheEnabled] = useState(() =>
    loadLS("vg_cacheEnabled", true),
  );
  const cacheEnabled =
    propCacheEnabled !== undefined ? propCacheEnabled : internalCacheEnabled;
  const [internalUiScale, setInternalUiScale] = useState<number>(() =>
    loadLS("vg_uiScale", 0),
  );
  const uiScale = propUiScale !== undefined ? propUiScale : internalUiScale;
  const [isClearingCache, setIsClearingCache] = useState(false);
  const [internalStartupNav, setInternalStartupNav] = useState(() =>
    loadLS("vg_startupNav", "home"),
  );
  ...
  const handleCacheLimitChange = async (limit: string) => {
    ...
    try {
      const pruned = await invoke<number>("prune_cache_if_needed", {
        maxBytes,
      });
      if (pruned > 0) {
  ...
  useEffect(() => {
    invoke<DiskInfo>("get_disk_usage", { path: downloadPath })
      .then(setDiskInfo)
      .catch(() => {});
    refreshCacheInfo();
  ...
  const matchesPlayback =
    ...
    (matchCard([
      ...
      matchCard(["Playback", "Audio Processing"]) ||
      matchCard([
        "Playback",
        "Equalizer",
        "EQ",
  ...
  const matchesStorage =
    ...
    (matchCard([
      "Storage",
      "Cache Storage & Auto-Cleaner",
      "Cache",
      "Enable Caching & Stream Prefetch",
      "Prefetch",
      "Cache Size Limit",
      "Auto-Cleaner",
      "Clear Cache",
      ...
      "Temp Storage",
      cacheLimit,
      cacheInfo?.formatted_size || "",
    ]) ||
      matchCard([
        "Storage",
        "Backup Location",
        "Download Directory",
        "phoebeats_backup.json",
        backupPath,
        downloadPath,
        "Save path",
        "Folder",
  ...
  const matchesUpdates =
    ...
    (matchCard([
      "Updates",
      "Check for new releases of Phoebeats",
      "Update available",
      "You're up to date",
      "Latest version",
      "GitHub",
          ...
          return (
            <button
              ...
              style={{
                ...
                color: isActive ? "var(--v-fg)" : "#8c8682",
                position: "relative",
              ...
              onMouseLeave={(e) => {
                if (!isActive) {
                  ...
                  e.currentTarget.style.color = "#8c8682";
                }
              }}
            >
              {isActive && (
              ...
              >
                {!searchQuery.trim() && (
                  <div>
                    ...
                    >
                      Configure the audio engine and playback behaviors.
                    </p>
                  </div>
                )}
                ...
                {(!searchQuery.trim() ||
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <Zap size={14} style={{ color: "#8c8682" }} /> Audio
                        Processing
                      </h3>
                    </div>
                    ...
                    >
                      <div>
                        ...
                        >
                          {loudnormEnabled
                            ? "Active — consistent volume across tracks (EBU R128)"
                            : "Disabled — raw volume, faster track start"}
                        </p>
                      </div>
                      <SettingsSwitch
                        ...
                        onChange={() => {
                          ...
                          const warn = validateSettingsChange(
                            "loudnormEnabled",
                            next,
                            { loudnormEnabled, skipSilence, eq },
                          );
                          if (warn) {
                            showToast(warn);
                          }
                    ...
                    >
                      <div>
                        ...
                        >
                          {skipSilence
                            ? "Active — auto-skips silent gaps"
                            : "Disabled — plays entire track including silence"}
                        </p>
                      </div>
                      <SettingsSwitch
                        checked={skipSilence}
                    ...
                    >
                      ...
                      >
                        {[
                          {
                            name: "Flat",
                            preset: { bass: 0, mid: 0, treble: 0 },
                          },
                          {
                            name: "Bass Boost",
                            preset: { bass: 7, mid: -1, treble: 2 },
                          },
                          {
                            name: "Vocal",
                            preset: { bass: -2, mid: 6, treble: 3 },
                          },
                          {
                            name: "Treble",
                            preset: { bass: -1, mid: 2, treble: 7 },
                          },
                          {
                            name: "Electronic",
                            preset: { bass: 6, mid: 1, treble: 5 },
                          },
                          {
                            name: "Rock",
                            preset: { bass: 5, mid: -2, treble: 5 },
                          },
                        ].map(({ name, preset }) => {
                          const isSelected =
                            eq.bass === preset.bass &&
                            eq.mid === preset.mid &&
                            eq.treble === preset.treble;
                          return (
                            <button
                              key={name}
                              onClick={() => {
                            ...
                            >
                              ...
                              <div
                                style={{
                                  ...
                                  pointerEvents: "none",
                                  transition:
                                    "left 0.08s ease-out, transform 0.15s ease",
              ...
              >
                {!searchQuery.trim() && (
                  <div>
                    ...
                    >
                      Customize application themes, accent colors, interface
                ...
                {(!searchQuery.trim() ||
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        Choose from one of our curated high-contrast dark modes.
                      </p>
                      <div
                        style={{
                          display: "grid",
                        ...
                        {[
                          {
                            id: "phoebe",
                            name: "Phoebe Glass",
                            desc: "Navy glass & video wallpaper",
                            bg: "#07101a",
                            cardBg: "#0c1724",
                            accent: "#72d5f4",
                          },
                          ...
                          return (
                            <div
                              ...
                              style={{
                                ...
                                justifyContent: "space-between",
                                background: isSelected
                                  ? "rgba(226,221,217,0.03)"
                                  : "rgba(226,221,217,0.005)",
                                border: isSelected
                                  ? "1px solid var(--v-accent)"
                          ...
                          <div style={{ display: "flex", gap: "5px" }}>
                            ...
                            <span
                              style={{
                                ...
                                height: "16px",
                                borderRadius: "50%",
                                background: lightenColor(customBgColor, 4),
                                border: "1px solid rgba(255,255,255,0.08)",
                              }}
                            />
                            <span
                        ...
                        >
                          ...
                          <div
                            style={{
                              ...
                              cursor:
                                theme === "custom" ? "pointer" : "default",
                              background:
                                "linear-gradient(45deg, #ff0055, #00ffcc, #9900ff)",
                              display: "flex",
                              alignItems: "center",
                              justifyContent: "center",
                              transition:
                          ...
                          >
                            <input
                              ...
                              disabled={theme !== "custom"}
                              onChange={(e) =>
                                setCustomBgColorState(e.target.value)
                              }
                              style={{
                                position: "absolute",
                                top: "-4px",
                ...
                {(!searchQuery.trim() ||
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        Choose a preset highlight color or select a custom color
                        profile.
                      </p>
                      <div
                        style={{
                      ...
                      >
                        ...
                        >
                          <input
                            ...
                            onChange={(e) =>
                              setAccentColorState(e.target.value)
                            }
                            style={{
                              position: "absolute",
                              top: "-4px",
                  ...
                  >
                    ...
                    >
                      <div>
                        ...
                        >
                          {trayEnabled
                            ? "Active — window minimizes to system tray on close"
                            : "Disabled — close exits the app entirely"}
                        </p>
                      </div>
                      <SettingsSwitch
                        checked={trayEnabled}
                        onChange={async () => {
                          ...
                          try {
                            await invoke("tray_set", { enabled: next });
                            setTrayEnabled(next);
                          } catch (e) {
                            showToast(`Tray unavailable: ${e}`);
                          }
                        }}
                      />
                    </div>
                ...
                {(!searchQuery.trim() ||
                  ...
                  >
                    ...
                    >
                      <div>
                        ...
                        >
                          ...
                          {startupNav === "stats"
                            ...
                            : startupNav === "home"
                              ? "Home"
                              : startupNav === "downloads"
                                ? "Offline"
                                : startupNav === "history"
                                  ? "History"
                                  : startupNav === "library" ||
                                      startupNav === "playlists"
                                    ? "Playlists"
                                    : startupNav === "last"
                                      ? "Last Opened View"
                                      : "Settings"}
                      ...
                      <ThemedSelect
                        value={
                          startupNav === "library" ? "playlists" : startupNav
                        }
                    ...
                    >
                      <div>
                        ...
                        >
                          {uiScale === 0
                            ? "Default scale (100%)"
                            : `${uiScale > 0 ? `+${uiScale}` : uiScale} (${100 + uiScale * 5}%)`}
                        </p>
                      </div>
                      <div
                        style={{
                    ...
                    >
                      ...
                      <SettingsSwitch
                        ...
                        onChange={() => {
                          ...
                          showToast(
                            next
                              ? "Low-Spec Mode enabled"
                              : "Low-Spec Mode disabled",
                          );
                        }}
                      />
                    </div>
              ...
              >
                {!searchQuery.trim() && (
                  <div>
                    ...
                    >
                      Configure download quality, formats, and folders.
                    </p>
                  </div>
                )}
                  ...
                  >
                      ...
                      <div>
                        ...
                        >
                          {downloadQuality === "High"
                            ? "Best available audio bitrate (320kbps+)"
                            : downloadQuality === "Medium"
                              ? "Balanced quality (~128kbps)"
                              : "Smallest file size"}
                        </p>
                      </div>
                      <ThemedSelect
                    ...
                    >
                      <div>
                        ...
                        >
                          {downloadFormat === "opus"
                            ? "Best compression, native YouTube codec"
                            : downloadFormat === "m4a"
                              ? "AAC in M4A, great Apple/car stereo compat"
                              : downloadFormat === "flac"
                                ? "Lossless — largest files"
                ...
                {(!searchQuery.trim() ||
                  ...
                  >
                    ...
                    >
                      <div style={{ flex: 1, minWidth: 0 }}>
                        <div
                          className="v-settings-path-capsule"
                          style={{
                            display: "inline-flex",
                            alignItems: "center",
                            gap: "6px",
                        ...
                        {diskInfo && (
                          ...
                          >
                            {formatBytes(diskInfo.used_bytes)} used ·{" "}
                            {diskInfo.track_count} offline tracks
                          </p>
                        )}
                      </div>
                      <button
                ...
                {(!searchQuery.trim() ||
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <Image size={14} style={{ color: "#8c8682" }} /> File
                        Options
                      </h3>
                    </div>
                    ...
                    >
                      <div>
                        ...
                        >
                          {embedThumbnail
                            ? "Active — album/track cover art is embedded into audio file tags"
                            : "Disabled — downloaded audio files will have no embedded cover"}
                        </p>
                      </div>
                      <SettingsSwitch
                        checked={embedThumbnail}
                        onChange={() => setEmbedThumbnail(!embedThumbnail)}
                      />
                    </div>
                    ...
                    >
                      <div>
                        ...
                        >
                          {duplicateDetect
                            ? "Active — tracks already in your download folder are skipped"
                            : "Disabled — duplicates will download and overwrite if triggered"}
                        </p>
                      </div>
                      <SettingsSwitch
                        checked={duplicateDetect}
                        onChange={() => setDuplicateDetect(!duplicateDetect)}
                      />
                    </div>
                  </div>
                )}
              ...
              >
                {!searchQuery.trim() && (
                  <div>
                    ...
                    >
                      Configure external integrations and social status
                      activity.
                    </p>
                  </div>
                )}
                  ...
                  >
                    ...
                    <div
                      style={{
                        ...
                        alignItems: "center",
                        justifyContent: "space-between",
                        borderBottom: discordRpcEnabled
                          ? "1px solid var(--v-bdr)"
                          : "none",
                      }}
                    >
                      <div>
                        ...
                        >
                          {discordStatus || "Waiting for playback"}
                        </p>
                        <p
                          style={{
                            fontSize: "12px",
                        ...
                        >
                          Open the Discord desktop app and enable activity
                          sharing in Discord settings.
                        </p>
                      </div>
                      <SettingsSwitch
                      ...
                      <>
                        ...
                        >
                          <div>
                            ...
                            >
                              Control how timestamps appear on your Discord
                              profile
                            </p>
                          </div>
                          <ThemedSelect
                        ...
                        >
                          ...
                          >
                            <div>
                              ...
                              >
                                Show a custom link button on your Discord
                                profile card
                              </p>
                            </div>
                            <SettingsSwitch
                      ...
                      <div>
                        ...
                        >
                          {lyricsSource === "musixmatch"
                            ? "Musixmatch — word-level richsync when available"
                            : lyricsSource === "netease"
                              ? "NetEase — great for Asian artists & translations"
                ...
                {(!searchQuery.trim() ||
                  ...
                  >
                    ...
                    >
                      ...
                      <button
                        onClick={() =>
                          openUrl("https://www.last.fm/api/account/create")
                        }
                        style={{
                          fontSize: "11.5px",
                          color: "#8a817c",
                        ...
                        onMouseLeave={(e) =>
                          (e.currentTarget.style.color = "#8a817c")
                        }
                      >
                    ...
                    >
                      <div>
                        ...
                        >
                          {lastfmEnabled
                            ? "Logs Now Playing updates and scrobbles to your Last.fm profile"
                            : "Disabled — scrobbles are not sent"}
                        </p>
                      </div>
                      <SettingsSwitch
                        checked={lastfmEnabled}
                        onChange={() => setLastfmEnabled(!lastfmEnabled)}
                      />
                    </div>
                          ...
                          >
                            <button
                              ...
                              onClick={async () => {
                                ...
                                if (!lfmAuthToken) {
                                  const res = await getLastFmAuthToken(
                                    key,
                                    secret,
                                  );
                                  setLfmTesting(false);
                                  if (res.success && res.token) {
                                    ...
                                    showToast(
                                      "Approve Phoebeats in the browser, then click Complete Connection",
                                    );
                                  } else {
                                    showToast(
                                      `Last.fm error: ${res.error || "Failed to start authorization"}`,
                                    );
                                  }
                                } else {
                                  const res = await createLastFmSession(
                                    lfmAuthToken,
                                    key,
                                    secret,
                                  );
                                  ...
                                  if (
                                    ...
                                    showToast(
                                      `Last.fm connected: @${res.username}`,
                                    );
                                  } else {
                                    showToast(
                                      `Last.fm: ${res.error || "Approval not completed yet"}`,
                                    );
                                  }
                                }
                              }}
                              style={{
                                ...
                                fontSize: "12px",
                                cursor:
                                  lastfmApiKey.trim() && lastfmApiSecret.trim()
                                    ? "pointer"
                                    : "not-allowed",
                                display: "flex",
                                alignItems: "center",
                            ...
                            >
                              <RefreshCw
                                size={12}
                                className={lfmTesting ? "animate-spin" : ""}
                              />
                              <span>
                                {lfmTesting
                                  ? "Processing..."
              ...
              >
                {!searchQuery.trim() && (
                  <div>
                    ...
                    >
                      Configure proxy servers and custom streaming mirror
                      instances.
                    </p>
                  </div>
                )}
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <RefreshCw
                          size={11}
                          className={
                            testConnStatus?.loading ? "animate-spin" : ""
                          }
                        />
                        <span>
                    ...
                    >
                      <div>
                        ...
                        >
                          Route audio streaming and search queries through a
                          custom proxy (e.g. <code>http://127.0.0.1:8080</code>{" "}
                          or <code>socks5://127.0.0.1:1080</code>)
                        </p>
                        <input
                          type="text"
                      ...
                      >
                        ...
                        >
                          Optional mirror endpoint for regions where YouTube /
                          Google Video CDN is restricted (e.g.{" "}
                          <code>https://pipedapi.kavin.rocks</code>)
                        </p>
                        <input
                          type="text"
                          placeholder="https://..."
              ...
              >
                {!searchQuery.trim() && (
                  <div>
                    ...
                    >
                      Manage local streaming cache, application backups, and
                      data retention.
                    </p>
                  </div>
                )}
                  ...
                  >
                    ...
                    >
                      ...
                      {cacheEnabled && (
                        <button
                          disabled={
                            isClearingCache || cacheInfo?.total_bytes === 0
                          }
                        ...
                        >
                          <RefreshCw
                            size={11}
                            className={isClearingCache ? "animate-spin" : ""}
                          />
                          <span>
                    ...
                    >
                      ...
                      <SettingsSwitch
                        ...
                        onChange={() => handleToggleCache(!cacheEnabled)}
                      />
                    </div>
                      ...
                      <>
                        ...
                        >
                          <div>
                            ...
                            >
                              {cacheInfo
                                ? `${cacheInfo.formatted_size} (${cacheInfo.file_count} cached media & thumbnail files)`
                        ...
                        >
                          <div>
                            ...
                            >
                              Automatically purges oldest cached streams and
                              temporary artwork when limit is reached
                            </p>
                          </div>
                          <ThemedSelect
                            value={cacheLimit}
                  ...
                  >
                    ...
                    >
                      <div style={{ flex: 1, minWidth: 0 }}>
                        ...
                        >
                          Backup file: phoebeats_backup.json
                        </p>
                      </div>
                      <button
                        style={{
                  ...
                  >
                    ...
                    >
                      <div>
                        ...
                        >
                          Save all playlists, queue, history, and settings to a
                          JSON file
                        </p>
                      </div>
                      <button
                    ...
                    >
                      <div>
                        ...
                        >
                          Restore playlists, history, and preferences from a
                          backup file
                        </p>
                      </div>
                      <button
                  ...
                  >
                    ...
                    >
                      <div>
                        ...
                        >
                          Permanently delete all local database contents,
                          playlists, history, and configuration files. This
              ...
              >
                {!searchQuery.trim() && (
                  <div>
                    ...
                    >
                      Check for new releases and view version status.
                    </p>
                  </div>
                )}
                  ...
                  >
                    ...
                    >
                      <div>
                        ...
                        >
                          Automatically check for new releases when launching
                          Phoebeats
                        </p>
                      </div>
                      <SettingsSwitch
                    ...
                    >
                      <div>
                        ...
                        >
                          Force a search for the latest version of Phoebeats on
                          GitHub
                        </p>
                      </div>
                      <button
